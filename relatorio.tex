...
\begin{document}
    ...
    O algoritmo faz no máximo uma quantidade constante de chamadas parra algoritmos lineares na quantidade de nós da árvore, além de chamadas de tempo constante. Assim, garantimos complexidade $T(k) \in O(k)$.
    ...
    \textbf{NÃO TO CONSEGUINDO FECHAR ESSA PROVA}


    \noindent Dois problemas: não consigo fazer o d\_B aparecer pq ele é definido pelo número médio de elementos em linhas não nulas da matriz B, e não consigo fazer o log de k\_B ser absorvido na complexidade.
