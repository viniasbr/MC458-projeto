...
\begin{document}
    ...
    O custo esperado da operação \texttt{setElement} é parecido ao de \texttt{getElement}. Fazemos um número constante de operações, com exceção da iteração do bucket, que tem número esperado de elementos constante. Portanto, $T(k) \in \Theta(1)$. 
    ...
    \begin{center}
    \input{tables_sizes.tex}
    \end{center}

    \subsection{Resultados de Tempo}
    \begin{table}[h]
        \centering
